...
urlpatterns = patterns('',
	...
	url(r'^admin/ajax_admin_del/(?P<id>\d)$', 'simple.views_admin.ajax_admin_del'),
	url(r'^admin/ajax_admin_updatepwd$', 'simple.views_admin.ajax_admin_updatepwd'),	
	url(r'^admin/ajax_art_single_get/(?P<id>\d)$', 'simple.views_admin.ajax_art_single_get'),
	url(r'^admin/ajax_art_single_update/(?P<id>\d)$', 'simple.views_admin.ajax_art_single_update'),	
	url(r'^admin/ajax_dataclass_list$', 'simple.views_admin.ajax_dataclass_list'),
	url(r'^admin/ajax_dataclass_get/(?P<id>\d)$', 'simple.views_admin.ajax_dataclass_get'),
	url(r'^admin/ajax_dataclass_add$', 'simple.views_admin.ajax_dataclass_add'),
	url(r'^admin/ajax_dataclass_add/(?P<id>\d)$', 'simple.views_admin.ajax_dataclass_add'),
	url(r'^admin/ajax_dataclass_del/(?P<id>\d)$', 'simple.views_admin.ajax_dataclass_del'),	
	url(r'^admin/ajax_data_list$', 'simple.views_admin.ajax_data_list'),
	url(r'^admin/ajax_data_get/(?P<id>\d)$', 'simple.views_admin.ajax_data_get'),
	url(r'^admin/ajax_data_add$', 'simple.views_admin.ajax_data_add'),
	url(r'^admin/ajax_data_add/(?P<id>\d)$', 'simple.views_admin.ajax_data_add'),
	url(r'^admin/ajax_data_del/(?P<id>\d)$', 'simple.views_admin.ajax_data_del'),
